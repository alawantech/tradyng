...
import { Menu, X, Home, Star, ShoppingBag, DollarSign, LogIn, MessageCircle, Sparkles, Video as VideoIcon } from 'lucide-react';
...
export const Navbar: React.FC = () => {
  ...
  const navLinks = [
    ...
    { to: '/tutorials', label: 'Tutorials', icon: VideoIcon },
