...
import { ArrowLeft, DollarSign, Users, CreditCard, Save, Copy, Check, Phone, MessageCircle, Building, Wallet, Clock, CheckCircle, XCircle, AlertCircle, Menu, X, LayoutDashboard, UserCheck, LogOut, Settings as SettingsIcon } from 'lucide-react';
...
type ActiveSection = 'overview' | 'referrals' | 'withdrawals' | 'bank-details' | 'profile';
...
export const AffiliateDashboard: React.FC = () => {
  ...
  const navigationItems = [
    ...
    { id: 'referrals' as ActiveSection, label: 'My Referrals', icon: Users },
    { id: 'withdrawals' as ActiveSection, label: 'Withdrawals', icon: Wallet },
    { id: 'bank-details' as ActiveSection, label: 'Bank Details', icon: CreditCard },
    { id: 'profile' as ActiveSection, label: 'Profile', icon: UserCheck },
  ];

  return (
    <div className="min-h-screen bg-gray-900">
      {/* Mobile Header */}
      <div className="lg:hidden bg-gray-800 border-b border-gray-700 fixed top-0 left-0 right-0 z-40">
        <div className="px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-white">Affiliate Dashboard</h1>
                <p className="text-xs text-gray-400">{affiliate.fullName}</p>
              </div>
            </div>
            <button
        ...
        {(sidebarOpen || window.innerWidth >= 1024) && (
          <>
            ...
            <motion.aside
              ...
              className="fixed top-0 left-0 h-full w-64 bg-gray-800 border-r border-gray-700 z-50 lg:z-30 overflow-y-auto"
            >
              {/* Desktop Header */}
              <div className="hidden lg:block p-6 border-b border-gray-700">
                ...
                <div>
                  <h2 className="text-xl font-bold text-white">Affiliate Portal</h2>
                  <p className="text-sm text-gray-400 mt-1">{affiliate.fullName}</p>
                  <p className="text-xs text-gray-500 mt-1">@{affiliate.username}</p>
                </div>
              </div>

              {/* Mobile user info */}
              <div className="lg:hidden p-4 border-b border-gray-700 mt-[73px]">
              ...
              <div className="p-4 mt-4 border-t border-gray-700">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm font-semibold text-white">{referrals.length}</span>
                  </div>
                  <div className="flex justify-between items-center">
              ...
              <div className="hidden lg:block p-4 border-t border-gray-700 mt-auto">
                <button
                  onClick={handleLogout}
      ...
      {/* Main Content */}
      <div className="lg:ml-64 pt-[73px] lg:pt-0 min-h-screen">
          ...
          {activeSection === 'referrals' && (
            ...
            >
              <div className="mb-6">
                ...
                <p className="text-gray-400 mt-1">View and manage all your referrals</p>
              </div>

              <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 space-y-4 sm:space-y-0">
                  <h3 className="text-xl font-semibold text-white">All Referrals</h3>
          ...
          {activeSection === 'withdrawals' && (
            ...
            >
              <div className="mb-6">
                ...
                <p className="text-gray-400 mt-1">Request and manage your withdrawals</p>
              </div>
          ...
          {activeSection === 'bank-details' && (
            ...
            >
              <div className="mb-6">
                ...
                <p className="text-gray-400 mt-1">Manage your bank account information</p>
              </div>

              <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
                <h3 className="text-xl font-semibold text-white mb-4">Bank Account Information</h3>
                <p className="text-gray-400 mb-6">
                ...
                <div className="space-y-4">
                  ...
                  <Button
                    ...
                    disabled={saving}
                    className="w-full py-3 bg-green-500 text-white rounded-lg hover:bg-green-600 flex items-center justify-center space-x-2 disabled:opacity-50"
                  >
                    {saving ? (
                      <>
                        <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white"></div>
          ...
          {activeSection === 'profile' && (
            ...
            >
              <div className="mb-6">
                ...
                <p className="text-gray-400 mt-1">View your affiliate profile information</p>
              </div>
              ...
              <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-b border-gray-700 pb-4">
                    ...
                    <p className="text-white font-medium">{affiliate.whatsappNumber}</p>
                  </div>

                  <div className="pb-4">
                    <label className="block text-sm font-medium text-gray-400 mb-1">Member Since</label>
                    <p className="text-white font-medium">{affiliate.createdAt?.toDate().toLocaleDateString()}</p>
                  </div>
                </div>
              </div>
            </motion.div>
