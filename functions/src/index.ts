...
export const checkTrialExpirations = functions.scheduler.onSchedule({
...
async function sendAdminTrialNotification(businessName: string, businessId: string, ownerEmail: string, daysRemaining: number) {
  try {
...
async function deleteExpiredBusiness(businessId: string, ownerId: string) {
  try {
...
export const sendWithdrawalStatusEmail = functions.https.onRequest({
  secrets: ['MAIL_SENDER_API_TOKEN']
}, async (req: Request, res: Response) => {
  res.set('Access-Control-Allow-Origin', '*');
  res.set('Access-Control-Allow-Methods', 'POST, OPTIONS');
...
// =======================
export const sendTrialReminder = functions.https.onRequest(
  {
    memory: '256MiB',
    timeoutSeconds: 60,
    minInstances: 0,
...
// =======================
export const adminDeleteBusiness = functions.https.onRequest(
  {
    memory: '256MiB',
    timeoutSeconds: 120,
    minInstances: 0,
